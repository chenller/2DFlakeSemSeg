...
@TRANSFORMS.register_module(name='ext-mmdet-PackDetInputs')
    ...
    def transform(self, results: dict) -> dict:
        ...
        if 'gt_seg_map' in results:
            gt_sem_seg_data = dict(
                sem_seg=to_tensor(results['gt_seg_map'][None, ...].copy()).long(),
                data=to_tensor(results['gt_seg_map'][None, ...].copy()).long(),
            )
